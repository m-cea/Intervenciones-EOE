  ...
  <div class="col-md-10">
    <form action="guardar EOE.php" method="POST">
      ...
      <div class="form-group">
        ...
        <input type="date" name="fecha" class="form-control" placeholder="Fecha" autofocus><p><br></p>
      </div>
      <div class="form-group">
        <label for="intervencion"> Intervención: </label><br><textarea name="intervencion" rows="3" cols="171" placeholder="Escribir aquí" autofocus></textarea><p><br></p>
      </div>
